...
def obtener_palabras_validas(noticia):
...
def palabras_mas_usadas(palabras):
    return sorted(palabras.items(), key=lambda palabra: palabra[1], reverse=True)[:10]
...
for i in range(0,3):
    ...
    print(noticias[i])
    print("")
    palabras = obtener_palabras_validas(noticias[i])
    print("Contiene las siguientes palabras válidas:")
    print(palabras)
    print("Las 10 palabras mas repetidas son:", palabras_mas_usadas(palabras))
